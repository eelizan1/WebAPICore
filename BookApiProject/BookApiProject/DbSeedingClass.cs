...
namespace BookApiProject
{
    ...
    {
        // "this" specifies that this is an extension method
        public static void SeedDataContext(this BookDbContext context)
        {
            var booksAuthors = new List<BookAuthor>()
            {
                // starting with the BookAuthor table lets us seed the rest of the tables in one shot because of the relationships
                new BookAuthor()
                {
                    Book = new Book()
                    {
            ...
            // add all these new objects to the context
            // Use BookAuthors table since that is what we are refereing to
